...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe(
      'pk_test_51PiM59EjheAN6rGA2IyFg2NGmPKT3WlNXVlwimd4xd5RYrasPMxQWkQP9n9rwt9QZqgKe9NVqSnyYcJIAVP1Q9s100zyn7MG1n'
    ).then((stripe) => {
      this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    ...
    if (!result) throw new Error('Problem with the payment');
    return result;
  }
